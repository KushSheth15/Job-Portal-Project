...
$cnt=mysqli_num_rows($qry);
					?>			<p class="card-text"><h4> <?php echo htmlentities($cnt);?> </h4></p>
					</div>
</div>
...
<div class="card bg-warning">
		<div class="card-body text-center">
						...
						<p class="card-text">
                             ...
                             $sql1 = "SELECT bid from bookings";
                             $qry1=mysqli_query($conn,$sql1);
                             $cnt1=mysqli_num_rows($qry1);
					                   ?>
								<p class="card-text"><h4><?php echo htmlentities($cnt1);?></h4></p>
		...
		<div class="card-body text-center">
						...
						<p class="card-text">
								<h3>Enquiries</h3>
												...
												<?php 
$sql2 = "SELECT eid from enquiry";
$qry2=mysqli_query($conn,$sql2);
$cnt2=mysqli_num_rows($qry2);
					?>
								<p class="card-text"><h4><?php echo htmlentities($cnt2);?></h4></p>
		...
		<div class="card-body text-center">
							...
							<p class="card-text" style='font-size:10px'>
									<h3>packages</h3>
																	...
																	<?php 
$sql3 = "SELECT ppid from package";
$qry3=mysqli_query($conn,$sql3);
$cnt3=mysqli_num_rows($qry3);
					?>
								<p class="card-text"><h4><?php echo htmlentities($cnt3);?></h4></p>
