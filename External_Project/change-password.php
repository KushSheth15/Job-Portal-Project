...
if (strlen($_SESSION['login']) == 0) {
	...
	if (isset($_POST['submit5'])) {
		...
		$sql = "SELECT Password FROM registrationTB WHERE Email='$email' and Password='$password'";
		$query = mysqli_query($con,$sql);
		
		if ($query > 0) {
			$sql1 = "update registrationTB set Password='$newpassword' where Email='$email'";
			$chngpwd1 = mysqli_query($con,$sql1);
